...
export const DELETE_EXCHANGE_RATE_OPTIMISTIC =
  "DELETE_EXCHANGE_RATE_OPTIMISTIC";
export const GET_SELECTED_EXCHANGE_RATE = "GET_SELECTED_EXCHANGE_RATE";
export const UPDATE_SELECTED_EXCHANGE_RATE = "UPDATE_SELECTED_EXCHANGE_RATE";
